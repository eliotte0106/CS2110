...
typedef struct student_t {
    ...
    assignment_t assignment; ///< Assignment the student needs help on
} student_t;
...
typedef struct queue_node_t {
    student_t data;     ///< The student held by this node
 ...
 */
extern queue_node_t *queue_head;
extern queue_node_t *queue_tail;
 ...
 */
extern int queue_add(student_t data);
 ...
 */
extern int queue_remove(student_t *data);
