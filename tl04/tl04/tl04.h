 ...
 *
 * This function should allocate a [queue_node_t] on the heap, and deep-copy all the other data.
 * In particular, any pointers in the [queue_node_t] will require their own dedicated memory allocation.
 * Make sure that all members of the [queue_node_t] are set!
 *
 * Finally, insert the student into the queue with the help of the [queue_head] and/or [queue_tail] pointers.
 * Refer back to the PDF/diagram for specific details about how to link the nodes.
 * 
