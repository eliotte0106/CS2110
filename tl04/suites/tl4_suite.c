...
static void _create_normal_queue(void) {
    student_t student1 = _create_temp_student(names[0], TIMED_LAB_4);
    _queue_add(student1);
    student_t student2 = _create_temp_student(names[1], HOMEWORK_3);
    _queue_add(student2);
    student_t student3 = _create_temp_student(names[2], QUIZ_2);
    _queue_add(student3);
}

static void assert_node_data_equals(queue_node_t *node, const char *nodeLabel, const char *origName, assignment_t assignment) {
...
START_TEST(test_queue_add_short_name) {
    ...
    assignment_t assignment = HOMEWORK_1;
    student_t student = _create_temp_student(name, assignment);
    queue_node_t *oldTail = queue_tail;
...
START_TEST(test_queue_add_long_name) {
    ...
    assignment_t assignment = QUIZ_4;
    student_t student = _create_temp_student(name, assignment);
    queue_node_t *oldTail = queue_tail;
    int success = queue_add(student);
...
START_TEST(test_queue_add_null_name) {
    ...
    assignment_t assignment = TIMED_LAB_1;
    student_t student = _create_temp_student(name, assignment);
    queue_node_t *oldTail = queue_tail;
    int success = queue_add(student);
...
START_TEST(test_queue_add_empty_string_name) {
    _create_normal_queue();
    const char *name = "";
    assignment_t assignment = HOMEWORK_10;
    student_t student = _create_temp_student(name, assignment);
    queue_node_t *oldTail = queue_tail;
    int success = queue_add(student);
...
START_TEST(test_queue_add_empty_list) {
    ...
    assignment_t assignment = HOMEWORK_4;
    student_t student = _create_temp_student(name, assignment);
    int success = queue_add(student);
...
START_TEST(test_queue_add_rest_of_list_unchanged) {
    ...
    assignment_t assignment = HOMEWORK_8;
    student_t student = _create_temp_student(name, assignment);
    queue_add(student);
