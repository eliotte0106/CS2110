...
extern int _queue_add(student_t);
extern int _queue_remove(student_t *);

extern student_t _create_temp_student(const char *name, assignment_t assignment);
extern void _delete_queue(void);
extern int _name_was_deepcopied(const char *name);
extern void _free_student_name_safe(student_t *student);
