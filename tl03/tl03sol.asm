...
to_lowercase
    ...
    LD  R0, to_lowercase_n65
    ADD R0, R1, R0
    BRn to_lowercase_endif

    LD  R0, to_lowercase_n90
    ADD R0, R1, R0
    BRp to_lowercase_endif

    LD  R0, to_lowercase_32
    ADD R0, R1, R0
    STR R0, R5, 3
...
; Constants for use in to_lowercase
to_lowercase_n65 .fill -65
to_lowercase_n90 .fill -90
to_lowercase_32  .fill  32
...
are_letters_equal
    ...
    ADD R1, R1, 1
    ADD R0, R0, R1
    BRz  are_letters_equal_y
    BRnp are_letters_equal_n

are_letters_equal_y
    AND R0, R0, 0
    ADD R0, R0, 1
    BR are_letters_equal_f
are_letters_equal_n
    AND R0, R0, 0
    BR are_letters_equal_f
